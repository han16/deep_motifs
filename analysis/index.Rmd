...
```{r, message=F, warning=F}
load("C:\\han\\Projects\\IntegratePPI\\forecASDPaper\\01_BrainSpan_matrix.RData") # bs is the brainspan data in foreASD paper 
foreASD=as_tibble(read.csv("C:\\han\\Projects\\IntegratePPI\\forecASDPaper\\forecASD_table.csv"))


length(intersect(rownames(bs), jack_fu_185_asd_genes$gene_id))
length(intersect(foreASD$symbol, jack_fu_185_asd_genes$gene_gencodeV33))
```
